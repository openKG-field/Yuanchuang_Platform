  ...
  methods: {
    ...
    buildPlanPrompt() {
      const sections = [
        ...
        '必须包含章节：1. 总览与目标 2. 架构图文字描述 3. 模块职责表(表格) 4. 数据与接口设计 5. 核心算法/逻辑 6. 逐步实施里程碑与迭代计划 7. 关键代码骨架 8. 测试策略 9. 部署与运维 10. 安全 & 性能 11. 风险与回滚策略。',
    ...
    buildCodeOnlyPrompt() {
      return [
        ...
        '请提供：目录结构建议、核心模块样例、接口/数据模型定义、1-2 个核心算法实现。',
